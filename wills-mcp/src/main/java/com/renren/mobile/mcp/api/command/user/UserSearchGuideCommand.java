...
public class UserSearchGuideCommand extends AbstractApiCommand {

	private static final Log logger = LogFactory.getLog(UserSearchGuideCommand.class);
    ...
    public ApiResult onExecute(ApiCommandContext context) {
       ...
       // int userId = context.getUserId();
        ...
        try {
            ...
            result = userService.searchGuideExt(NumberUtils.toInt(city), NumberUtils.toInt(gender), scenic, NumberUtils.toInt(start), NumberUtils.toInt(rows));
            McpUtils.rpcTimeCost(t, "user.searchGuide");
        } catch (Exception e) {
            // 异常记录日志， 返回错误信息
