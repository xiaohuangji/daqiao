...
public class GuideEventRefuseCommand extends AbstractApiCommand{

	private static final Log logger = LogFactory.getLog(GuideEventRefuseCommand.class);
    ...
    public ApiResult onExecute(ApiCommandContext context) {
        ...
        try {
            ...
            result = guideEventService.refuse(NumberUtils.toLong(eventId), guideId, NumberUtils.toInt(userId));
            McpUtils.rpcTimeCost(t, "guideEvent.refuse");
        } catch (Exception e) {
            // 异常记录日志， 返回错误信息
