...
public class InviteEventGetOneInviteEventCommand extends AbstractApiCommand{

	private static final Log logger = LogFactory.getLog(InviteEventGetOneInviteEventCommand.class);
    ...
    public ApiResult onExecute(ApiCommandContext context) {
        ...
        try {
            ...
            result = inviteEventService.getOneInviteEvent(userId, NumberUtils.toLong(eventId));
            McpUtils.rpcTimeCost(t, "inviteEvent.getone");
        } catch (Exception e) {
            // 异常记录日志， 返回错误信息
