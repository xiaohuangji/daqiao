...
public class UserChangeHeadUrlCommand extends AbstractApiCommand {

	private static final Log logger = LogFactory.getLog(UserChangeHeadUrlCommand.class);
    ...
    public ApiResult onExecute(ApiCommandContext context) {
       ...
       int userId = context.getUserId();
        ...
        try {
            ...
            result = userService.changeHeadUrl(userId, headUrl);
