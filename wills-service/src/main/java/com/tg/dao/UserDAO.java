...
public interface UserDAO {
	...
	@SQL("insert into user_pwd (user_id,md5_pwd) values (:1,:2)")
	...
	@SQL("insert into guide_info (user_id,good_at_scenic,birthday,be_guide_year,guide_card_url,guide_card_id,location,city,evaluate_score,evaluate_count,status) value" +
